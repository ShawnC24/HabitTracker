...
export 'addahabit_model.dart';

class AddahabitWidget extends StatefulWidget {
  /// Create a add a habit page, this page can include stuff about adding a
...
class _AddahabitWidgetState extends State<AddahabitWidget> {
  late AddahabitModel _model;
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed('presetSEttings');
                              },
                              child: Row(
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed('presetSEttingsCopy');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed('customizepage');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed('walkdogcustomization');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
                      ...
                      var confirmDialogResponse = await showDialog<bool>(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: const Text(
                                    'You sure you want to add this Habit?'),
                                actions: [
                                  TextButton(
