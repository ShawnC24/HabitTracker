                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: const AlignmentDirectional(0.0, 0.0),
                              child: StreamBuilder<List<AddFriendsRecord>>(
                                stream: queryAddFriendsRecord(
                                  queryBuilder: (addFriendsRecord) =>
                                      addFriendsRecord.where(
                                    'receiverId',
                                    isEqualTo: currentUserUid,
                                  ),
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  List<AddFriendsRecord>
                                      listViewAddFriendsRecordList =
                                      snapshot.data!;
                                  ...
                                  return ListView.separated(
                                    ...
                                    scrollDirection: Axis.vertical,
                                    itemCount:
                                        listViewAddFriendsRecordList.length,
                                    separatorBuilder: (_, __) =>
                                        const SizedBox(height: 2.0),
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewAddFriendsRecord =
                                          listViewAddFriendsRecordList[
                                              listViewIndex];
                                      return Row(
                                        mainAxisSize: MainAxisSize.max,
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                highlightColor:
                                                    Colors.transparent,
                                                onTap: () async {
                                                  await listViewAddFriendsRecord
                                                      .reference
                                                      .update(
                                                          createAddFriendsRecordData(
                                                    status: 'Accepted',
                                                  ));
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'You successfully added${listViewAddFriendsRecord.sendId}',
                                                        style: TextStyle(
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'You rejected ${listViewAddFriendsRecord.sendId}',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,
