...
class SocialPageWidget extends StatefulWidget {
  /// i need a social page where you can add friends and track their habits
  /// while they can track yours and you can both share a habit together, add
  /// the functionalities with it too
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(25.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1618780179533-870736eaea58?w=500&h=500',
                                          width: 50.0,
                                          height: 50.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(25.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1526149217525-7035aed11799?w=500&h=500',
                                          width: 50.0,
                                          height: 50.0,
                                          fit: BoxFit.cover,
                                        ),
