                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await AddFriendsRecord.collection
                                        .doc()
                                        .set(createAddFriendsRecordData(
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'You successfully added$currentUserEmail',
                                          style: FlutterFlowTheme.of(context)
                                              .labelSmall
                                              .override(
                                                fontFamily: 'Inter',
                                        ...
                                        backgroundColor: const Color(0xFF10E916),
                                      ),
                                    );
                                  },
